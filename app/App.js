    ...
    return (
      <span>
        ...
        <div className={styles.grid}>
          <div className={styles.cell} onClick={this.choose.bind(this, 0, 0)}>{this.displaySquare(0, 0)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 0, 1)}>{this.displaySquare(0, 1)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 0, 2)}>{this.displaySquare(0, 2)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 1, 0)}>{this.displaySquare(1, 0)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 1, 1)}>{this.displaySquare(1, 1)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 1, 2)}>{this.displaySquare(1, 2)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 2, 0)}>{this.displaySquare(2, 0)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 2, 1)}>{this.displaySquare(2, 1)}</div>
          <div className={styles.cell} onClick={this.choose.bind(this, 2, 2)}>{this.displaySquare(2, 2)}</div>
        </div>
      </span>
    );
  }
